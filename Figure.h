...
namespace Figure
{
	...
	*****************************************************************************************************/
	inline bool IntersectRectReaction(FloatRect* const rcMove, const FloatRect*const rcHold,Direction::Enum*const pOutDirection = nullptr)
	{
		...
		//std::cout << interH <<"높이" <<std::endl;
		//std::cout << interW <<"너비"<< std:: endl;
	...
	*****************************************************************************************************/
	...
	inline bool IntersectTriangleToRect(const Figure::FloatTriangle* triangle, const FloatRect* rc)
	{
	...
	## RectMake ##
	*****************************************************************************************************/
	inline FloatRect FRectMake(const float& x, const float& y,const float& width,const float& height)
	{
		FloatRect result;
		result.left = x;
		result.top = y;
	...
	inline FloatRect FRectMake(const Vector2& pos,const Vector2& size)
	{
		FloatRect result;
		result.left = pos.x;
		result.top = pos.y;
